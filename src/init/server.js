...
if (process.env.NODE_ENV === "development") {
  ...
  const webpackConfig = require("../config/webpack.config.dev.babel.js")
    .default;
...
app.use(
  "/dist",
  staticAsset(path.resolve(__dirname, "../../dist/"), {
...
app.listen(APP_PORT_NUM, () =>
  console.log(`Server running at http://localhost:${APP_PORT_NUM}`)
);
